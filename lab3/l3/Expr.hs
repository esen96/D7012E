...
-- Evaluation function, based on the principles of the lab 2 parser
value :: Expr -> Dictionary.T String Integer -> Integer
value (Num n) _ = fromIntegral n 
value (Var v) dic = case Dictionary.lookup v dic of Just w -> w ; _ -> error ("undefined variable " ++ v)
...
value (Div l r) dic 
        | value r dic == 0  = error "division by 0"
        | otherwise         = div (value l dic) (value r dic)
